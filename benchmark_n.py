#!/usr/bin/env python3
"""Benchmark YOLOv8n best weights on test split; extract overall + per-class metrics."""
import json
...
def main():
    ...
    # Per-class metrics using class_result
    per_class = []
    ...
    result = {
        "model": "yolov8n",
        "best_weights": "models/yolov8n_best.pt",
        "split": "test",
        "overall": {
            "P": float(P_all),
            "R": float(R_all),
    ...
    with open("benchmarks/benchmark_n.json", "w") as f:
        json.dump(result, f, indent=2)

    print("=== YOLOv8n Benchmark (test) ===")
